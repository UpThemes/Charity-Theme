...
if (!class_exists('cfct_module_image')) {
					...
					<div id="'.$this->id_base.'-image-selectors">
						...
						<ul>
							...
							<li>
								...
								<select name="'.$this->get_field_id('link_img_size').'">
					';
			$image_sizes = get_intermediate_image_sizes();
			foreach ($image_sizes as $size) {
				$html .= '
									<option value="'.$size.'"'.selected($size, $link_img_size, false).'>'.$this->humanize($size, true, array('-')).'</option>';
			}
			$html .= '
								</select>
							</li>
	...
	cfct_build_register_module('cfct-module-image', 'cfct_module_image');
}
?>