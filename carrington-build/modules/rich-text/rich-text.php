...
if (!class_exists('cfct_module_rich_text')) {
	class cfct_module_rich_text extends cfct_build_module {
		...
		public function footer_js() {
			...
			echo '<script type="text/javascript" src="'.$baseurl.'/tiny_mce.js?'.$tinymce_version.'"></script>'.PHP_EOL;
		}
	...
	cfct_build_register_module('cfct-rich-text-module', 'cfct_module_rich_text');
}
?>