...
$options = array (
    ...
    array(  "name" => __("Ads Below Header (HTML or Javascript)", "charity"),
            "desc" => __("Paste full ad code in this box.", "charity"),
            "id" => "top_ads",
            "type" => "textarea",
            "attr" => array("rows" => "8")),

    array(  "name" => __("Ads Above Footer (HTML or Javascript)", "charity"),
            "desc" => __("Paste full ad code in this box.", "charity"),
            "id" => "bottom_ads",
            "type" => "textarea",
            "attr" => array("rows" => "8"))
